...
/** 5 — Why Sky Wash. Credibility row, stat treatment. */
export function WhyUs() {
  return (
    <section className="relative bg-void py-32 md:py-44">
      <div className="shell">
        <Reveal>
          <Kicker>{WHY_US.kicker}</Kicker>
        </Reveal>
        <Reveal delay={0.05}>
          <h2 className="mt-8 max-w-3xl text-display-sm font-semibold text-paper">{WHY_US.headline}</h2>
        </Reveal>
